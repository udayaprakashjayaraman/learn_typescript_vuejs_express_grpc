...
const PROTO_PATH: string = __dirname + "/../../server-2-typescript/proto/product.proto" 
...
function approveProductGrpc(product: any) {
  ...
  client.approveProduct({product: product}, function(err: any, response: {message: string}) {
